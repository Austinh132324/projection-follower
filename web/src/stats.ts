// Client-side filtering + aggregation. Mirrors backend src/normalize/bet.ts so
// the dashboard recomputes stats reactively for whatever filter is active,
// identically in mock mode and against the real API.
